...
<body class="hold-transition sidebar-mini layout-fixed">
    <button type="button" class="btn btn-danger swalDefaultError" style="display: none"></button>
<div class="wrapper">
  <!-- Preloader -->
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url()?>/public/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="<?php echo base_url();?>/logout" class="nav-link"><span class="ion-power" title="Logout" data-glyph="power-standby"></span></a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
